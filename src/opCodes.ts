...
export const shortFlag = (b: number): boolean => ((b & 0x20) > 0) && ((b & 0x9f) > 0) ? false : true

// Return reports whether the opcode has the return flag set.
export const returnFlag = (b: number): boolean => (b & 0x40) > 0 && (b & 0x9f) > 0

// Keep reports whether the opcode has the keep flag set.
export const keepFlag = (b: number): number => ((b & 0x80) > 0 && (b & 0x1f) > 0) ? 1 : 0
